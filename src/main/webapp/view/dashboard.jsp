                  ...
                  <div class="modal-body">
                    ...
                    <form:form action="${pageContext.request.contextPath}/fruits/add" method="POST" modelAttribute="fruit" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <form:textarea type="text" class="form-control" id="fruitDescription" aria-describedby="fruitDescription" placeholder="description" path="description" required="true"/>                        </div>
                        <div class="form-group">
